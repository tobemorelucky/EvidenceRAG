    ...
    trace.update(
        {
            ...
            "field_aware_enabled": meta.get("field_aware_enabled", False),
            ...
            "page_first_anchor_window": meta.get("page_first_anchor_window", 0),
            "page_first_selected_documents": meta.get("page_first_selected_documents", []) or [],
            "page_first_selected_pages": meta.get("page_first_selected_pages", []) or [],
            "supplemental_search_attempted": meta.get("supplemental_search_attempted", False),
            "supplemental_search_query": meta.get("supplemental_search_query", ""),
            "supplemental_search_filenames": meta.get("supplemental_search_filenames", []) or [],
            "supplemental_search_candidate_count": meta.get("supplemental_search_candidate_count", 0),
            "evidence_coverage_before_supplemental": meta.get("evidence_coverage_before_supplemental", {}),
            ...
            "rerank_provider": meta.get("rerank_provider"),
            "remote_rerank_candidate_count": meta.get("remote_rerank_candidate_count"),
            "remote_rerank_anchor_count": meta.get("remote_rerank_anchor_count"),
            "remote_rerank_input_chars": meta.get("remote_rerank_input_chars"),
            "remote_rerank_rate_limited": meta.get("remote_rerank_rate_limited"),
            "remote_attempt_count": meta.get("remote_attempt_count", 0),
            "remote_success": meta.get("remote_success", False),
            "remote_errors": meta.get("remote_errors", []) or [],
            "rerank_cache_hit": meta.get("rerank_cache_hit", False),
            "rerank_fallback_used": meta.get("rerank_fallback_used", False),
            "rerank_fallback_reason": meta.get("rerank_fallback_reason", ""),
            "rerank_trace": meta.get("rerank_trace", {}) or {},
...
def retrieve_initial(state: RAGState) -> RAGState:
    ...
    rag_trace = {
        ...
        "retrieve_error": retrieve_meta.get("retrieve_error"),
