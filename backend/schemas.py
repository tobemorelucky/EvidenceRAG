...
class RagTrace(BaseModel):
    ...
    evidence_frame_enabled: Optional[bool] = None
    evidence_frame_count: Optional[int] = None
    table_frame_count: Optional[int] = None
    evidence_frame_tables_considered: Optional[int] = None
    evidence_frame_tables_accepted: Optional[int] = None
    frames_with_period: Optional[int] = None
    frames_with_unit_scale: Optional[int] = None
    frames_used_for_execution: Optional[int] = None
    evidence_frame_skipped: Optional[dict] = None
    evidence_frame_load_ms: Optional[float] = None
    evidence_frame_load_errors: Optional[List[str]] = None
    evidence_frame_page_window: Optional[int] = None
    evidence_frame_adjacent_page_tables: Optional[int] = None
    queryspec_concepts: Optional[List[str]] = None
    frame_match_candidates: Optional[List[dict]] = None
    frame_match_method: Optional[str] = None
    ...
    numeric_display_validation: Optional[dict] = None
    answer_facet_validation: Optional[dict] = None
    candidate_coverage: Optional[dict] = None
    selected_page_coverage: Optional[dict] = None
    compact_context_coverage: Optional[dict] = None
    candidate_to_selected_transition: Optional[str] = None
    selected_to_compact_transition: Optional[str] = None
    evidence_flow_stage: Optional[str] = None
    protected_page_slots_enabled: Optional[bool] = None
    protected_pages: Optional[List[dict]] = None
    protected_page_replacements: Optional[List[dict]] = None
    protected_page_count: Optional[int] = None
    protected_page_coverage_before: Optional[dict] = None
    protected_page_coverage_after: Optional[dict] = None
    protected_page_coverage_transition: Optional[str] = None
    selected_page_count_before_protection: Optional[int] = None
    selected_page_count_after_protection: Optional[int] = None
    supplemental_find_enabled: Optional[bool] = None
    supplemental_triggered: Optional[bool] = None
    supplemental_query: Optional[str] = None
    ...
    coverage_after: Optional[dict] = None
    answer_context_protected_slots_enabled: Optional[bool] = None
    answer_context_protected_evidence: Optional[List[dict]] = None
    answer_context_dropped_protected_evidence: Optional[List[dict]] = None
